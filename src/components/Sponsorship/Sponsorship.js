...
const mrkTk = 'https://res.cloudinary.com/cepheus22/image/upload/v1640179039/samples/WHITE-LOGO-2_hf0reo.webp';

const cmpM = 'https://res.cloudinary.com/cepheus22/image/upload/v1640178112/samples/Campus_memories_logo_c2w0sf.webp';

const gfg = 'https://res.cloudinary.com/cepheus22/image/upload/v1640179091/samples/GFG_LOGO-3_1_kxtdlj.webp';

const mentX = 'https://res.cloudinary.com/dijzrwmrb/image/upload/q_auto:eco/v1639985612/images/mentor-wb_m53utr.webp';
...
const grbOn = 'https://res.cloudinary.com/cepheus22/image/upload/v1640235760/grabonin_xxkr7d.jpg';
...
const sponsH = [
	...
	// },
	{
		...
		cls: 'saving-s',
		key: 7,
		companies: [{ logo: grbOn, name: 'Grab-On', webL: 'https://www.grabon.in/' }],
		isN: false,
	},
	{
