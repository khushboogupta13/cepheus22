...
const q2 =
  "Q2. Is a mechatronics degree worth it or we should go for a focussed program?";
...
const q3 =
  "Q3. Will a mechatronic engineer have a good future in the upcoming 5-10 years?";
...
const q5 =
  "Q5. Can I use the open-source code of someone to enhance my program/model?";
...
const q7 =
  "Q7. is it necessary to use Jupyter notebook or can we use other editors also?";
...
const a8 =
  "No, as the complexity of the game increases you have to use more advance libraries and code for the same.";
...
const a11 =
  "You must add the content that is already provided. You may improvise when it comes to the optional features part.";

const q12 =
  "Q12. Can a person with a basic understanding of Arduino Uno participate?";
...
const q13 =
  "Q13. Do we have to use any online simulator for designing the circuits?";
const a13 =
  "There is no need of any online simulator but if you require then you can use circuitverse, EDA playground or other online/offline VHDL based simulator or any online circuit design simulator.";

const q14 = `Q14. What is FizzBuzz's plagiarism policy?`;
const a14 =
  "All the submissions will be checked for plagiarism using a high end plag checker. If any kind of conspiracy is found then it will lead to direct disqualification.";

const q15 = "Q15. Can we skip one level and go to the next level?";
const a15 =
  "No. The next level can be unlocked only when all of the previous levels have been successfully completed. There would be five levels in total.";
