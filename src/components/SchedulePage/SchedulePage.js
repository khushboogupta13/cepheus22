					...
					<div className='sch_calander'>
						...
						<div className='cal_dates'>
							...
							<span className='cepheus_dates'>
								<span onClick={() => setDate(3)} className={date === 3 ? 'active' : null}>
									&nbsp;3&nbsp;
								</span>{' '}
								&nbsp;
								<span onClick={() => setDate(4)} className={date === 4 ? 'active' : null}>
									&nbsp;4&nbsp;
								</span>{' '}
								&nbsp;&nbsp;
								<span onClick={() => setDate(5)} className={date === 5 ? 'active' : null}>
									&nbsp;5&nbsp;
								</span>
							</span>
							&nbsp; &nbsp;6 &nbsp; &nbsp;7 &nbsp; &nbsp;8 <br />
