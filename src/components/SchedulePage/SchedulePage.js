...
import events  from "./assets/schedule.js"
  ...
  <table className="sch_events">
    <tbody>
      {events
        ...
        .map((event) => (
          <tr className="sch_event" key={event.id}>
            <td>
